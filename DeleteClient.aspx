<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteClient.aspx.cs" Inherits="WebApplication_Final_Assignment.DeleteClient" %>
...
<body>
    ...
    <form id="AddNewClient" runat="server">
        ...
        <div class="frm_row_cont">
            <asp:Button ID="BtnDeleteClient" runat="server" Text="Delete Client" Onclick="BtnDeleteClient_Click"/>
        </div>
    </form>
        </div>
        </center>
