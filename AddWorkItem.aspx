<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkItem.aspx.cs" Inherits="WebApplication_Final_Assignment.WorkItem" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlWorkID" runat="server"></asp:TextBox><br />
            <asp:RequiredFieldValidator 
                ID="rfvWorkID"
                ControlToValidate="CtrlWorkID" 
                Display="Static"
                runat="server" 
        ...
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlDate" runat="server"></asp:TextBox><br />
            <asp:RequiredFieldValidator 
                ID="rfvDate"
        ...
        <div class="frm_row_cont">
            <asp:Label ID="LblWorkItemComm" runat="server" Text="Work Item Comment:"></asp:Label><br />
            <asp:TextBox ID="CtrlWorkItemComm" runat="server" TextMode="MultiLine" Height="75px"></asp:TextBox>
        </div>
        <div class="frm_row_cont">
            <asp:Button ID="BtnAddWorkIitem" runat="server" Text="Add Item" Onclick="BtnAddWorkIitem_Click"/>
