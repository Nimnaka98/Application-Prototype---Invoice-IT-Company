<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateWorkItem.aspx.cs" Inherits="WebApplication_Final_Assignment.UpdateWorkItem" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="frm_row_cont">
            <asp:Button ID="BtnUpdateWorkItem" runat="server" Text="Update Work Item" OnClick="BtnUpdateWorkItem_Click" />
