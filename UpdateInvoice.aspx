<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateInvoice.aspx.cs" Inherits="WebApplication_Final_Assignment.UpdateInvoice" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlInvoiceDate" runat="server"></asp:TextBox><br />
            <!-- <asp:RequiredFieldValidator ID="rfvInvoiceDate"
                ControlToValidate="CtrlInvoiceDate" 
                Display="Static"
                runat="server"
                ErrorMessage="This field is required."></asp:RequiredFieldValidator> -->
        </div>
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlInvoiceSentDate" runat="server"></asp:TextBox><br />
            <!-- <asp:RequiredFieldValidator ID="rfvInvoiceSentDate"
        ...
        <div class="frm_row_cont">
            <asp:Label ID="LblInvoiceStatus" class="frmlabel" runat="server" Text="Select a Invoice Status"></asp:Label>
            <br />
        ...
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlBusinessName" runat="server"></asp:TextBox><br />
            <!-- <asp:RequiredFieldValidator ID="rfvBusinessName"
                ControlToValidate="CtrlBusinessName" 
                Display="Static"
                runat="server"
                ErrorMessage="This field is required."></asp:RequiredFieldValidator> -->
        </div>
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlStartDate" runat="server"></asp:TextBox><br />
        ...
        <div class="frm_row_cont">
            ...
            <asp:TextBox ID="CtrlEndDate" runat="server"></asp:TextBox><br />
            <!-- <asp:RequiredFieldValidator ID="rfvEndDate"
                ControlToValidate="CtrlEndDate" 
                Display="Static"
                runat="server"
                ErrorMessage="This field is required."></asp:RequiredFieldValidator> -->
        </div>
